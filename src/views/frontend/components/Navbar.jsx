    ...
    return (
        <div className="header-bottom header-bottom-bg-color sticky-bar">
            <div className="container">
                <div className="header-wrap justify-content-center header-space-between position-relative">
                    ...
                    <div className="header-nav d-none d-lg-flex">
                        ...
                        <div className="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul>
                                    <li className="hot-deals"><img src="assets/images/icon-hot.svg" alt="hot deals" /><a href="shop-grid-right.html">Deals</a></li>
                                    <li>
                                        <a className="active" href="index.html">Home <i className="fi-rs-angle-down" /></a>
