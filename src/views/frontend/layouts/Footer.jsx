                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="position-relative newsletter-inner">
                                    ...
                                    <img src="/assets/images/banner-9.png" alt="newsletter" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="col">
                                <div className="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay={0}>
                                    <div className="logo mb-30">
                                        <a href="index.html" className="mb-15"><img src="/assets/images/logo.svg" alt="logo" /></a>
                                        <p className="font-lg text-heading">Awesome grocery store website template</p>
                                    </div>
                                    <ul className="contact-infor">
                                        <li><img src="/assets/images/icon-location.svg" alt="" /><strong>Address: </strong> <span>5171 W Campbell Ave undefined Kent, Utah 53127 United States</span></li>
                                        <li><img src="/assets/images/icon-contact.svg" alt="" /><strong>Call Us:</strong><span>(+91) - 540-025-124553</span></li>
                                        <li><img src="/assets/images/icon-email-2.svg" alt="" /><strong>Email:</strong><span><a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="1063717c75505e7563643e737f7d">[email&nbsp;protected]</a></span></li>
                                        <li><img src="/assets/images/icon-clock.svg" alt="" /><strong>Hours:</strong><span>10:00 - 18:00, Mon - Sat</span></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 text-end d-none d-md-block">
                            <div className="mobile-social-icon">
                                <h6>Follow Us</h6>
                                <a href="#"><img src="/assets/images/icon-facebook-white.svg" alt="" /></a>
                                <a href="#"><img src="/assets/images/icon-twitter-white.svg" alt="" /></a>
                                <a href="#"><img src="/assets/images/icon-instagram-white.svg" alt="" /></a>
                                <a href="#"><img src="/assets/images/icon-pinterest-white.svg" alt="" /></a>
                                <a href="#"><img src="/assets/images/icon-youtube-white.svg" alt="" /></a>
                            </div>
